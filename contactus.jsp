    ...
    <td rowspan="2" align="right" valign="top"><table width="740" height="239" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<%
			...
			String query="insert into contactus values('"+sname+"' ,'"+phone+"' ,'"+email+"' ,'"+address+"' ,'"+organisation+"' ,'"+designation+"' ,'"+contactTime+"','"+message+"')";
			...
			out.println("Thank you for showing Interest with our company. We will in touch with you.");
			}
			catch(Exception ex)
			{
		%>
