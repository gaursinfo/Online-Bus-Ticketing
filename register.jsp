    ...
    <td rowspan="2" align="right" valign="top"><table width="740" height="239" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<%
			...
			String txtdesg=request.getParameter("txtdesg");

			String query="insert into register values('"+sname+"','"+phone+"','"+email+"','"+adrs+"','"+txtorg+"','"+txtdesg+"')";
			...
			out.println("Congratulations! by taking the decision to register with us, you have made a smart move for your present and future hassle-free travel journeys.");
			}
			catch(Exception ex)
			{
		%>
