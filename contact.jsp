...
<table width="972" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td rowspan="2" align="right" valign="top"><table width="740" height="239" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
	  <%!
	  double id=generateRandomNumber(1000,9999999);
	  
	  %>
        <td valign="top" bgcolor="#E8E8E8" class="welcome_cnt"><span class="pagetitle">Your Query is Successfully Submitted  </span><br />
		<h1>Your ticket is successfully booked. Note down your book id:<%=+id%></h1>
		<%
			try
			{
			String chktrip=(String) session.getAttribute("chktrip");
			String source=(String) session.getAttribute("source");
			String destination=(String) session.getAttribute("destination");
			String txtdoj=(String) session.getAttribute("txtdoj");
			String lst_bustyp=(String) session.getAttribute("lst_bustyp");
			String lst_psgno=(String) session.getAttribute("lst_psgno");
			
			String sname=request.getParameter("sname");
			String mobile=request.getParameter("mobile");
			String email=request.getParameter("email");
			
			String query="insert into contact values("+id+",'"+chktrip+"','"+source+"', '"+destination+"','"+txtdoj+"', '"+lst_bustyp+"', '"+lst_psgno+"','"+sname+"','"+mobile+"','"+email+"')";
			...
			out.println("Your details will we feed successfully. Our representative will be in touch with you.");
			}
			catch(Exception ex)
			{
		%>
