  ...
  <tr>
    ...
    <td rowspan="2" align="right" valign="top"><table width="740" height="239" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<%
			String chktrip=request.getParameter("chktrip");
			String source=request.getParameter("source");
			String destination=request.getParameter("destination");
			String txtdoj=request.getParameter("txtdoj");
			String lst_bustyp=request.getParameter("lst_bustyp");
			String lst_psgno=request.getParameter("lst_psgno");
	
			
			session.setAttribute("chktrip",chktrip);
			session.setAttribute("source",source);
			session.setAttribute("destination",destination);
			session.setAttribute("txtdoj",txtdoj);
			session.setAttribute("lst_bustyp",lst_bustyp);
			session.setAttribute("lst_psgno",lst_psgno);
		%>
	  <form name="contact" method="post" action="contact.jsp">
	  <h2>Please also enter following details to Continue...!</h2>
			  <table width="474" border="0" cellpadding="3" cellspacing="1" class="balcktxt">
				<tr>
				  <td width="102">Name </td>
				  <td width="12">:</td>
				  <td width="150"><input type="text" name="sname"/></td>
				  <td width="181" class="balcktxt"><span id="errorsDiv_txttktno"></span></td>
				</tr>
				<tr>
				  <td width="102">Mobile </td>
				  <td width="12">:</td>
				  <td width="150"><input type="text" name="mobile"/></td>
				  <td width="181" class="balcktxt"><span id="errorsDiv_txttktno"></span></td>
				</tr>
				<tr>
				  <td>Email</td>
				  ...
				  <td class="balcktxt"><span id="errorsDiv_txtemail" class="balcktxt"></span></td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td colspan="2">
						<input type="submit" name="btnsbmt"   id="btnsbmt" value="Submit" onclick="return cnfrm();"/>&nbsp;
						<input type="reset" name="btncancel" id="btncancel" value="Clear"/>
					</td>
				</tr>
				 <tr>
				  <td colspan="4" align="center" class="redtxt"></td>
				  </tr>
			  </table>
			  </form>
