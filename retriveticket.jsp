...
<table width="972" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td rowspan="2" align="right" valign="top"><table width="740" height="239" border="0" align="right" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top" bgcolor="#E8E8E8" class="welcome_cnt"><span class="pagetitle">Your Ticket Details are :-  </span><br />
		<%
			try
			{ 
		...
		%>
			<table border="1">
			<tr><th>Book Id</th><th>Trip Type</th><th>Source</th><th>Destination</th><th>Date of Journey</th></tr>
		<%
		while(rs.next())
		{
		%>
...
<a href="index.html" class="footerlink">Home</a> | <a href="#" class="footerlink">About Us</a> | <a href="#" class="footerlink">Plan Your Journey</a> | <a href="#" class="footerlink">News And Information</a> | <br />
				<a href="#" class="footerlink">Terms of Use</a> | <a href="#" class="footerlink">Privacy Policy</a> | <a href="#" class="footerlink">Sitemap</a> | <a href="#" class="footerlink">Careers</a> | <a href="#" class="footerlink">FAQ's</a> | <a href="contactus.html" class="footerlink">Contact Us</a><br />
